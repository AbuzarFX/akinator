...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        .setDescription(`Akinator currently supports 16 languages. It is \`English\` by default. __**To use some other language, specify the language code in the end of the command.**__\n
